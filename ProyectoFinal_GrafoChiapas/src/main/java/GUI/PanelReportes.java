    ...
    private void initComponents() {
        ...
        scrollPane.setPreferredSize(new Dimension(700, 400));
                            textAreaReportes.setText("""
                                             ...
                                             T(n) TOTAL DE LA APLICACION:
                                             
                                             T(n) Implementacion : 5n + 91 (Vertices, Aristas y Grafo)
                                             T(n) Algoritmos: 38n´3 + 434n´2 + 415n + 458 (Recorridos, MST y Ruta mas corta)
                                             T(n) Interfaz Grafia: 1637n´2 + 4360n + 4004
                                             
                                             T(n) TOTAL: 38n´3 + 2071n´2 + 4780n + 4553
                                             O(n´3)     /         O(E)   / O(v"3)
                                             
                                             O(E) debido a que al estar tomando los mismos vertices constantes, esta se
                                             Multiplicara por las aristas O(20E), omitiendo la constante
            ...
            if (panelOpcionesBusqueda.isVisible() || panelOpcionesMST.isVisible() || panelOpcionesRuta.isVisible()) {
                if (panelActual != null) {
                    ...
                    textAreaReportes.setText("""
                                             ...
                                             O(E) debido a que al estar tomando los mismos vertices constantes, esta se
                                             Multiplicara por las aristas O(40E), omitiendo la constante
